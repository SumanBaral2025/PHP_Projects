...
if (isset($_SESSION['signup_success'])) {
    ...
    echo "<script>alert(" . json_encode($successMessage) . ");</script>";
...
<body>
    <div class="signup-container">
        ...
        <form class="signup-form" id="signupForm" method="post" action="index.php">
            <div class="name-fields">
                <input type="text" name="name" maxlength="20" placeholder="Enter your name" required>
            </div>
            <input type="text" name="email_phone" maxlength="20" placeholder="Mobile number or email address" required>
...
$conn = mysqli_connect($servername, $username, $password, $database);// Create a connection
if (!$conn){
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Check if the form was submitted via POST
    ...
    $sql = "INSERT INTO signup (name, email_phone, password,  date) 
